      ...
      <div className="mx-auto max-w-screen-2xl px-4 py-12 md:py-20">
        <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
          ...
          <div className="order-1">
            <h1 className="font-heading mb-4 font-bold leading-tight text-primary">
              <span className="block text-5xl md:text-6xl">Orthodontie in {city}</span>
              <span className="mt-3 block text-3xl font-bold text-primary md:text-4xl">
                Voor kinderen en volwassenen die klaar zijn voor resultaat dat blijft.
              </span>
            </h1>
            <p className="mb-8 text-base leading-relaxed text-neutral md:text-lg">
              Of je nu 14 of 44 bent — wij behandelen met de modernste technieken.
              Inclusief transparante aligners.
            </p>
            <button
          ...
          <div className="order-2 flex justify-center md:justify-end">
            <div className="relative h-72 w-full max-w-sm overflow-hidden rounded-2xl shadow-lg md:h-[520px] md:max-w-none">
              {heroFailed ? (
